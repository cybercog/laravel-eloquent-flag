...
final class AcceptedFlagScopeTest extends TestCase
{
    ...
    public function test_it_can_get_without_not_accepted(): void
    {
        EntityWithAcceptedFlag::factory()->count(3)->create([
            'is_accepted' => true,
        ]);
    ...
    public function test_it_can_get_with_not_accepted(): void
    {
        EntityWithAcceptedFlag::factory()->count(3)->create([
            'is_accepted' => true,
        ]);
    ...
    public function test_it_can_get_only_not_accepted(): void
    {
        EntityWithAcceptedFlag::factory()->count(3)->create([
            'is_accepted' => true,
        ]);
    ...
    public function test_it_can_accept_model(): void
    {
    ...
    public function test_it_can_undo_accept_model(): void
    {
        $model = EntityWithAcceptedFlag::factory()->create([
            'is_accepted' => true,
        ]);
