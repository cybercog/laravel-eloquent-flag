...
final class KeptFlagScopeTest extends TestCase
{
    ...
    public function test_it_can_get_without_not_kept(): void
    {
        EntityWithKeptFlag::factory()->count(3)->create([
            'is_kept' => true,
        ]);
    ...
    public function test_it_can_get_with_not_kept(): void
    {
        EntityWithKeptFlag::factory()->count(3)->create([
            'is_kept' => true,
        ]);
    ...
    public function test_it_can_get_only_not_kept(): void
    {
        EntityWithKeptFlag::factory()->count(3)->create([
            'is_kept' => true,
        ]);
    ...
    public function test_it_can_keep_model(): void
    {
    ...
    public function test_it_can_undo_keep_model(): void
    {
        $model = EntityWithKeptFlag::factory()->create([
            'is_kept' => true,
        ]);
